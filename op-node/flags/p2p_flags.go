...
var (
	...
	SequencerP2PSignerEndpoint = "p2p.sequencer.signer.endpoint"
...
func P2PFlags(envPrefix string) []cli.Flag {
	return []cli.Flag{
		...
		&cli.StringFlag{
			Name:     SequencerP2PSignerEndpoint,
			Usage:    "Endpoint to a remote signer for signing off on p2p application messages as sequencer.",
			Required: false,
			Value:    "",
			EnvVars:  p2pEnv(envPrefix, "SEQUENCER_SIGNER_ENDPOINT"),
			Category: P2PCategory,
		},
		&cli.UintFlag{
