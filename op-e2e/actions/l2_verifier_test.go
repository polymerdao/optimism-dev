...
func setupVerifier(t Testing, sd *e2eutils.SetupData, log log.Logger, l1F derive.L1Fetcher, syncCfg *sync.Config, daConfig *eigenda.Config) (*L2Engine, *L2Verifier) {
	...
	verifier := NewL2Verifier(t, log, l1F, mockBlobFetcher, engCl, sd.RollupCfg, syncCfg, daConfig)
...
func setupVerifierOnlyTest(t Testing, sd *e2eutils.SetupData, log log.Logger) (*L1Miner, *L2Engine, *L2Verifier) {
	...
	engine, verifier := setupVerifier(t, sd, log, l1Cl, &sync.Config{}, &eigenda.Config{})
